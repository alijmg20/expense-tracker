...
export default function ExpenseForm({ onSubmit, onClose, initialData, isRepeat }: ExpenseFormProps) {
  ...
  const inputClass = "w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent";
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Ej: Compra para la cena del viernes"
              rows={2}
